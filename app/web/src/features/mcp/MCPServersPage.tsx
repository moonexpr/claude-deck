...
export function MCPServersPage() {
  ...
  const estimatedTime = serverCount * 10;
          ...
          {managedServers.length > 0 && (
            <Card className="border-amber-500/50 bg-amber-50/50 dark:bg-amber-950/20">
              <CardHeader className="pb-3">
                ...
                <CardDescription>
                  These servers are configured by your organization and cannot be
                  modified.
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-2">
                        This controls whether Claude Code asks for permission before
                        using MCP tools. Per-server overrides can be set in each
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              time: ~{estimatedTime}s. Each test spawns a subprocess and may take
              up to 30s for npx-based servers.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
