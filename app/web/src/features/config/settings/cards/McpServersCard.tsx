    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid gap-2">
          ...
          <p className="text-sm text-muted-foreground">Specific servers to approve from .mcp.json</p>
          <ListEditor
        ...
        <div className="grid gap-2">
          ...
          <p className="text-sm text-muted-foreground">Specific servers to reject from .mcp.json</p>
          <ListEditor
