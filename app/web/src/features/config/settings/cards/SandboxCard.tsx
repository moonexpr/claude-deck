    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid gap-2">
          ...
          <p className="text-sm text-muted-foreground">Commands that bypass sandbox isolation</p>
          <ListEditor
        ...
        <div className="grid gap-2">
          ...
          <p className="text-sm text-muted-foreground">Network domains accessible from sandbox</p>
          <ListEditor
        ...
        <div className="grid gap-2">
          ...
          <p className="text-sm text-muted-foreground">Unix socket paths accessible in sandbox</p>
          <ListEditor
